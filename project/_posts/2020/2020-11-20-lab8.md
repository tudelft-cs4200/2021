...
See the [Git documentation](/project/lab1d) on how to check out this branch.
...
We provide you with an initial ChocoPy project in the branch `assignment-3-template`.
...
This is done similar to the builder for pretty-printing. Add the following rewrite rule to `trans/ChocoPy.str`:
